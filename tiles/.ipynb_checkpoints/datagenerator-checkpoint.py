...
class Dataset:
    ...
    def decode(self, serialized_example):
        ...
        features_dict = {'image': tf.io.FixedLenFeature([*self.params['tile_dims'], self.n_channels], tf.float32),
                         'mask': tf.io.FixedLenFeature([*self.params['tile_dims'], self.n_classes], tf.float32)}
